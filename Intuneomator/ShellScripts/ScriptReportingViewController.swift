//
//  ScriptReportingViewController.swift
//  Intuneomator
//
...
/// View controller for displaying detailed device run states for shell scripts
...
class ScriptReportingViewController: NSViewController {
    ...
    /// The shell script data for which to display device run states
    ...
    override func viewWillAppear() {
        ...
        if let window = view.window {
            window.title = "Shell Script Device Report"
    ...
    private func setupUI() {
        ...
        if let scriptData = scriptData,
           ...
           let lastModifiedDateString = scriptData["lastModifiedDateTime"] as? String {
            ...
            scriptNameLabel.stringValue = "Device Report for Shell Script"
    ...
    private func updatePieChart() {
        ...
        pieChart.updateData(
            ...
            notApplicable: 0, // Shell scripts don't have "not applicable" state
            total: totalDevices,
    ...
    private func loadDeviceRunStates() {
        ...
        XPCManager.shared.getShellScriptDeviceRunStates(scriptId: scriptId) { [weak self] deviceStates in
    ...
    @IBAction func openInIntuneButtonClicked(_ sender: NSButton) {
        ...
        openAppInIntuneConsole(scriptId: scriptId)
    }
    ...
    private func openAppInIntuneConsole(scriptId: String) {
        let intuneURL = "https://intune.microsoft.com/#view/Microsoft_Intune_DeviceSettings/ConfigureWMPolicyMenuBlade/~/deviceExecutionStatus/policyId/\(scriptId)/policyType~/1"
    ...
    private func exportToCSV() {
        ...
        let scriptName = (scriptData?["displayName"] as? String ?? "ShellScript").replacingOccurrences(of: " ", with: "")
...
extension ScriptReportingViewController: NSTableViewDataSource {
...
extension ScriptReportingViewController: NSTableViewDelegate {
