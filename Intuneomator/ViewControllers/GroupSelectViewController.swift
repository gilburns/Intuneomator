...
protocol GroupSelectViewControllerDelegate: AnyObject {
...
class GroupSelectViewController: NSViewController, NSTableViewDelegate, NSTableViewDataSource {
    ...
    // MARK: - Outlets
    @IBOutlet weak var groupAssignTitleField: NSTextField!
    ...
    override func viewDidLoad() {
        ...
        if assignmentType.isEmpty {
            groupAssignTitleField.stringValue = "Select a group"
        } else {
            groupAssignTitleField.stringValue = "\(assignmentType) assignment for \(displayName)"
        }
    ...
    @IBAction func saveButtonClicked(_ sender: NSButton) {
        ...
        delegate?.groupSelectViewController(self, didSelectGroups: selections, forAssignmentType: assignmentType)
        self.dismiss(self)
    }
